...
//     /**
//      * Add the duplicate user unsuccessfully.
//      * return 409 conflict
//      * @throws Exception
//      */
//     @Test
//     @Order(2)
//     public void testAddDuplicateUser_InValid_Return409() throws Exception{
//         JSONObject requestParams = new JSONObject();
//         requestParams.put("full_name", "Mark Tan"); 
//         // nric must be unique and follow the Singapore NRIC format
//         requestParams.put("nric", nric1);
...
//     /**
//      * Customer trying to create another customer. invalid authentication 
//      * return 403
//      * @throws Exception
//      */
//     @Test
//     @Order(21)
//     public void testAddUser_InValidPermission_Return403() throws Exception{
//         JSONObject requestParams = new JSONObject();
//         requestParams.put("full_name", "Mark Tan"); 
//         // nric must be unique and follow the Singapore NRIC format
//         requestParams.put("nric", nric2);
//         // valid Singapore number
//         requestParams.put("phone", "93223235");
//         requestParams.put("address", "27 Jalan Alamak S680234");
//         // unique username
//         requestParams.put("username", "FailUser2");
//         requestParams.put("password", "FailUser2");
//         requestParams.put("authorities", "ROLE_USER");
//         requestParams.put("active", true);
...
//     /**
//      * Customer trying to view other user's profile
//      * New customer is added first
//      * 
//      * @throws Exception
//      */
//     @Test
//     @Order(22)
//     public void testViewUser_InValidViewingOtherUser_Return403() throws Exception{
//         JSONObject requestParams = new JSONObject();
//         requestParams.put("full_name", "Mark John"); 
//         // nric must be unique and follow the Singapore NRIC format
//         requestParams.put("nric", nric2);
//         // valid Singapore number
//         requestParams.put("phone", "93263235");
//         requestParams.put("address", "27 Jalan Alamak S680234");
//         // unique username
//         requestParams.put("username", "user212345");
//         requestParams.put("password", "blank");
//         requestParams.put("authorities", "ROLE_USER");
//         requestParams.put("active", true);
...
//                 .accept("*/*")
//                 .contentType("application/json")
//                 .get(TestConstants.customerURL + "/" + user_id_3)
//                 .then()
//                 .statusCode(403);
